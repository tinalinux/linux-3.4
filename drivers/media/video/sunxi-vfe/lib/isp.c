...
unsigned int bsp_isp_set_size(enum pixel_fmt *fmt,
...
int isp_module_init(struct isp_gen_settings *isp_gen,
		    struct isp_3a_result *isp_result)
{
	return 0;
}
...
void bsp_isp_s_white_balance_temperature(struct isp_gen_settings *isp_gen,
					 int value)
{
	return;
}
...
void bsp_isp_s_power_line_frequency_auto(struct isp_gen_settings *isp_gen,
					 int value)
{
	return;
}
...
void bsp_isp_s_auto_focus_win_num(struct isp_gen_settings *isp_gen, int value,
...
void bsp_isp_s_auto_exposure_win_num(struct isp_gen_settings *isp_gen,
				     int value, struct isp_h3a_coor_win *coor)
{
	return;
}
...
void bsp_isp_s_exposure_auto_priority(struct isp_gen_settings *isp_gen,
				      int value)
{
	return;
}
...
void bsp_isp_s_auto_n_preset_white_balance(struct isp_gen_settings *isp_gen,
					   int value)
{
	return;
}
...
int get_pre_ev_cumul(struct isp_gen_settings *isp_gen,
		     struct isp_3a_result *isp_result)
{
	return 0;
}
...
void config_sensor_next_exposure(struct isp_gen_settings *isp_gen,
				 struct isp_3a_result *isp_result)
{
	return;
}
